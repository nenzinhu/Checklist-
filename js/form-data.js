/**
 * Compatibilidade: a estrutura de abas/campos agora é dinâmica (ver schema.js).
 * Estes re-exports mantêm a API usada por form.js, validation.js, review.js etc.
 * O admin monta o checklist em tempo de execução pelo Editor de Formulário.
 */
