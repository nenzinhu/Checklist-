/**
 * Esquema dinâmico do checklist (portado do vanilla → ESM).
 * Abas e campos são descritos por este SCHEMA guardado no localStorage.
 * O admin monta o checklist pelo Editor de Formulário.
 *
 * Tipos de campo: text, textarea, number, date, select, selectextra,
 * multiselect, simnao.
 */

export const SCHEMA_KEY = "checklist:schema";
...
export function buildDefaultSchema() {
  const tabs = [
    { id: "identificacao", label: "Identificação", order: 0, fields: [
      ...
      { id: "viatura", key: "viatura", label: "VIATURA PREFIXO", type: "select", options: ["PM 5592","PM 5599","PM 6997","PM 5312","PM 5484","PM 5471"], required: true, order: 1 },
    ]},
    ...
    { id: "comunicacao", label: "Comunicação", order: 2, fields: [
      ...
      equipField("impressora", "IMPRESSORA", ["LEOPARDO FINAL 9FF7","LEOPARDO FINAL 1359","LEOPARDO FINAL AE77","LEOPARDO FINAL 102","LEOPARDO FINAL 76","LEOPARDO FINAL 2B","LEOPARDO FINAL 8B","LEOPARDO FINAL 67","LEOPARDO FINAL 98B7"], "Selecione", 1),
      equipField("radioHt", "RÁDIO HT", ["FINAL 647","FINAL 649","FINAL 652","FINAL 654","FINAL 656"], "Selecione", 2),
    ]},
    { id: "armamento", label: "Armamento", order: 3, fields: [
      equipField("calibre12", "CALIBRE 12", ["FINAL 647","FINAL 649","FINAL 652","FINAL 654","FINAL 656"], "Selecione ou MANUAL/NÃO ACAUTELADO", 0),
      ...
      equipField("fuzil", "FUZIL", ["FINAL 647","FINAL 649","FINAL 652","FINAL 654","FINAL 656","NÃO LEVOU"], "Selecione ou MANUAL/NÃO ACAUTELADO", 2),
